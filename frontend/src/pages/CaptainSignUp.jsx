...
const CaptainSignUp = () => {
  ...
  return (
    <div className='p-7 flex flex-col justify-between h-screen '>
      <div>
        <img className='w-16  mb-4' src="https://staging.svgrepo.com/show/505031/uber-driver.svg" alt="" />
        <form onSubmit={(e) => submitHandler(e)}>

          <h3 className='mb-2 text-lg font-medium'>Captain name.?</h3>
          ...
          <h3 className='mb-2 text-lg font-medium'>Captain email.</h3>
          ...
          <p className='text-center mb-1 text-base '>Already have a Account.?<Link
            className='text-blue-500' to="/captain/login">Login here</Link></p>
        </form>
      </div>
      <div>
